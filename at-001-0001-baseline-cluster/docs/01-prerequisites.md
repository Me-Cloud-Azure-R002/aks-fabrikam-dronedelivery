...
1. Clone/download this repo locally, or even better, fork this repository.
   ...
   ```bash
   export GITHUB_REPO=https://github.com/Me-Cloud-Azure-R002/aks-fabrikam-dronedelivery.git
...
1. [JQ](https://stedolan.github.io/jq/download/)
    ...
    jq uses a C library for decimal number support. This is an ICU 1.8.1 licensed code obtained from the ICU downloads archive [icu-project](http://download.icu-project.org/files/decNumber/decNumber-icu-368.zip).

   AT - This library could either be installed to the current environment via Anaconda-Navigator.
